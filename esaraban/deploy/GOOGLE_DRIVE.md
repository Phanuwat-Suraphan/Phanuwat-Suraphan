...
- เก็บสำเนาสองชั้น ในโฟลเดอร์ **"สำเนาฐานข้อมูล (ห้ามลบ)"** ใต้โฟลเดอร์หลักของระบบ:
  - **ชุดล่าสุด 12 ชุด** (ราว 1 ชั่วโมงที่ผ่านมา) — กันเซิร์ฟเวอร์ดับกะทันหัน
  - **วันละ 1 ชุด ย้อนหลัง 90 วัน** (เก็บชุดสุดท้ายของแต่ละวัน) — กันกรณีเพิ่งมารู้ตัววันหลังว่าลบ/แก้ผิด
  - ชื่อไฟล์เป็นวันเวลาไทย เช่น `esaraban-2026-08-21-1530.db` หาสำเนาของวันที่ต้องการได้เอง
...
`BACKUP_KEEP_RECENT` (ค่าเริ่มต้น 12), `BACKUP_KEEP_DAYS` (ค่าเริ่มต้น 90)
